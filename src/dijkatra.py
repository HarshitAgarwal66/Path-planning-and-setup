...
class navigation_leader:
	...
	def __init__(self,gx,gy):
		...
		self.path_pub = rospy.Publisher("/trajectory/current", PolygonStamped,queue_size=1)

		#subscribe to position topics.
		# move one meter forward when we get new pose. do it once ####
		self.pose_sub = rospy.Subscriber("/initialpose", PoseStamped,self.pose_cb,queue_size=1)
...
if __name__ == '__main__':
	...
	print("Navigation script is ALIVE")
